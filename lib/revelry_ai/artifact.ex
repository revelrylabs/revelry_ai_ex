defmodule RevelryAI.Artifact do
  ...
  They are generated by passing input into a skill. Inputs come from
  up to three places:
   ...
   - document queries: semantically similar parts of documents are automatically
     found within a collection of documents, and inserted into the skill's prompt
  ...
  - document attachments: an entire document, such as something uploaded by you,
    is inserted into the skill's prompt prior to generation
  """
